...
import weibo4j.model.FriendshipsMutual;
...
public class Friendships extends Request {
	public Friendships(Weibo weibo) {
		super(weibo);
	...
	public UserWapper getFriendsBilateral(String uid, Integer sort, Paging page) throws WeiboException {
		return User
				.constructWapperUsers(weibo.getClient()
	...
	public String[] getFriendsBilateralIds(String uid) throws WeiboException {
		return User.constructIds(weibo.getClient().get(
	...
	public String[] getFriendsBilateralIds(String uid, Integer sort, Paging page) throws WeiboException {
		return User
				.constructIds(weibo.getClient()
						.get(WeiboConfig.getValue("baseURL") + "friendships/friends/bilateral/ids.json",
								new PostParameter[] { new PostParameter("uid", uid),
										new PostParameter("sort", sort.toString()) }, page));
	}
	...
	public String[] getFriendsIdsByName(String screen_name, Integer count, Integer cursor) throws WeiboException {
		return User
				.constructIds(weibo.getClient().get(
						WeiboConfig.getValue("baseURL") + "friendships/friends/ids.json",
						new PostParameter[] { new PostParameter("screen_name", screen_name),
	...
	public JSONArray getRemark(String uids) throws WeiboException {
		return weibo.getClient().get(WeiboConfig.getValue("baseURL") + "friendships/friends/remark_batch.json",
	...
	public User createFriendshipsById(String uid) throws WeiboException {
		return new User(weibo.getClient().post(WeiboConfig.getValue("baseURL") + "friendships/create.json",
	...
	public User destroyFriendshipsDestroyById(String uid) throws WeiboException {
		return new User(weibo.getClient().post(WeiboConfig.getValue("baseURL") + "friendships/destroy.json",
				new PostParameter[] { new PostParameter("uid", uid) }).asJSONObject());
	}
	 ...
	 * @version weibo4j-V2 1.0.0
	 * @see <a
	 *      href="http://open.weibo.com/wiki/2/friendships/friendships/show">friendships/show</a>
	 * @since JDK 1.5
	 */
	public FriendshipsMutual showFriendshipsMutual(String sid, String tid) throws WeiboException {
		/*
		 * return new
		 * FriendshipsMutual(weibo.getClient().post(WeiboConfig.getValue
		 * ("baseURL") + "friendships/show.json", new PostParameter[] { new
		 * PostParameter("target_id", tid), new PostParameter("source_id", sid)
		 * }));
		 */
		return new FriendshipsMutual(this.weibo.getClient().get(getBaseUrl() + "show.json",
				new PostParameter[] { new PostParameter("source_id", sid), new PostParameter("target_id", tid) }));
	}
