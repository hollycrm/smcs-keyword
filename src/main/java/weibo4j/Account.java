...
public class Account extends Request{
	...
	public List<School> getAccountPrpfileSchoolList() throws WeiboException {
		return School.constructSchool(weibo.getClient().get(WeiboConfig
	...
	public List<School> getAccountPrpfileSchoolList(Integer province,
		...
		return School.constructSchool(weibo.getClient().get(
	...
	public RateLimitStatus getAccountRateLimitStatus() throws WeiboException {
		return new RateLimitStatus(weibo.getClient().get(WeiboConfig
