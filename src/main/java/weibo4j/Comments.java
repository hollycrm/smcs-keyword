...
public class Comments extends Request{
	public Comments(Weibo weibo) {
		super(weibo);
	...
	public CommentWapper getCommentById(String id) throws WeiboException {
		return Comment.constructWapperComments(weibo.getClient().get(
	...
	public CommentWapper getCommentByMe() throws WeiboException {
		return Comment.constructWapperComments(weibo.getClient().get(WeiboConfig
	...
	public Comment createComment(String comment, String id)
			throws WeiboException {
		return new Comment(weibo.getClient().post(WeiboConfig.getValue("baseURL")
