...
public class Timeline extends Request{
	...
	public StatusWapper getFriendsTimeline() throws WeiboException {
		return Status.constructWapperStatus(weibo.getClient().get(WeiboConfig.getValue("baseURL") + "statuses/friends_timeline.json"));
	...
	public JSONObject getFriendsTimelineIds() throws WeiboException {
		return weibo.getClient().get(WeiboConfig.getValue("baseURL") + "statuses/friends_timeline/ids.json").asJSONObject();
	...
	public JSONObject getUserTimelineIdsByUid(String uid) throws WeiboException{
		return weibo.getClient().get(WeiboConfig.getValue("baseURL")+"statuses/user_timeline/ids.json",new PostParameter[]{
			new PostParameter("uid", uid)
		}).asJSONObject();
	}
	...
	public JSONObject getMentionsIds() throws WeiboException {
		return weibo.getClient().get(WeiboConfig
	...
	public StatusWapper getBilateralTimeline() throws WeiboException{
		return Status.constructWapperStatus(weibo.getClient().get(WeiboConfig.getValue("baseURL")+"statuses/bilateral_timeline.json"));
	}
	...
	public JSONObject QueryMid(Integer type, String id) throws WeiboException {
		return weibo.getClient().get(WeiboConfig.getValue("baseURL") + "statuses/querymid.json",
				new PostParameter[] { new PostParameter("id", id),
	...
	public Status Repost(String id, String status, Integer is_comment)
			throws WeiboException {
		return new Status(weibo.getClient().post(WeiboConfig.getValue("baseURL") + "statuses/repost.json", new PostParameter[] {
