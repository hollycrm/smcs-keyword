...
public class Tags extends Request{
	...
	public List<Tag> getTags(String uid) throws WeiboException {
		return Tag.constructTags(weibo.getClient().get(WeiboConfig.getValue("baseURL")
	...
	public List<Tag> getTags(String uid, Paging page) throws WeiboException {
		return Tag
				.constructTags(weibo.getClient().get(WeiboConfig.getValue("baseURL")
	...
	public JSONArray createTags(String tags) throws WeiboException {
		return weibo.getClient().post(WeiboConfig.getValue("baseURL") + "tags/create.json",
	...
	public JSONObject destoryTag(Integer tag_id) throws WeiboException {
			return weibo.getClient().post(WeiboConfig.getValue("baseURL") + "tags/destroy.json",
