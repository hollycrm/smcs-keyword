...
public class Favorite extends Request{
	public Favorite(Weibo weibo) {
		super(weibo);
	...
	public List<Favorites> getFavorites() throws WeiboException {
		return Favorites.constructFavorites(weibo.getClient().get(WeiboConfig
	...
	public List<Favorites> getFavorites(Paging page) throws WeiboException {
		return Favorites.constructFavorites(weibo.getClient().get(
	...
	public Favorites showFavorites(String id) throws WeiboException {
		return new Favorites(weibo.getClient().get(WeiboConfig.getValue("baseURL")
				+ "favorites/show.json",
	...
	public List<FavoritesTag> getFavoritesTags() throws WeiboException {
		return Tag.constructTag(weibo.getClient().get(WeiboConfig
	...
	public Favorites createFavorites(String id) throws WeiboException {
		return new Favorites(weibo.getClient().post(WeiboConfig.getValue("baseURL")
