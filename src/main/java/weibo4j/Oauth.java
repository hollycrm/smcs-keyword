...
public class Oauth extends Request{
	public String access_token;
	public String user_id;
  private Long appKey;
  private String appSecret;
	public Oauth(Weibo weibo) {
		super(weibo);
	...
	public AccessToken getAccessTokenByCode(String code) throws WeiboException {
		return new AccessToken(weibo.getClient().post(
				WeiboConfig.getValue("accessTokenURL"),
				new PostParameter[] {
						new PostParameter("client_id",appKey),
						new PostParameter("client_secret", appSecret),
